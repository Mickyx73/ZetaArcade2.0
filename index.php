...
<body>
        ...
        <div class="container">
            <div class="heading align-top">
                <h2 class="text-align-center">
                    <i class="bx bxs-flame"></i>Trending Games
                </h2>
            </div>
            <div class="slider">
                <div class="slide-track">
                    <div class="slide">
                        <img src="img/games/trending2.jpg" alt="" />
                    </div>
                    <div class="slide">
                        <img src="img/games/trending2.jpg" alt="" />
                    </div>
    ...
    <section class="all-games">
        <div class="container">
            <div class="heading align-top trending h2 i">
                <h2 class="text-align-center">
                    <i class="bx bx-compass"></i>Explore More Games!
                </h2>
            </div>
            <div class="all-games-grid">
                <div class="explore-box">
                    <img src="img/games/trending2.jpg" alt="">
                    <div class="exbox-cont">
                        <h2>Dyinglight 2</h2>
                        ...
                        <div class="rating-download">
                            ...
                            <a href="#" class="exbox-btn"><i class="bx bx-down-arrow-alt"></i></a>
                        </div>
                    </div>
                </div>
                <div class="explore-box">
